...
function GitHubIcon() {
  return (
    <svg
      className="community-link-card__icon"
      width="22"
      height="22"
      viewBox="0 0 24 24"
      fill="currentColor"
      ...
      <div className="community-link-cards">
        ...
        >
          ...
          <div className="community-link-card__body">
            <span className="community-link-card__title">
              XnneHangLab / yutto-uiya
            </span>
            <span className="community-link-card__desc">
              github.com/XnneHangLab/yutto-uiya
            </span>
          </div>
        ...
        >
          ...
          <div className="community-link-card__body">
            ...
            <span className="community-link-card__desc">
              space.bilibili.com/3461562564086372
            </span>
          </div>
          <span className="community-link-card__arrow">›</span>
        </button>
