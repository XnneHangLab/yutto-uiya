...
def main() -> None:
    ...
    st.set_page_config(page_title="Yutto-Uiya", layout="wide")
    st.title("Yutto-Uiya - Bilibili 下载工具")
...
def single_video_tab() -> None:
    """UI for downloading a single video."""
    st.markdown("""
    ...
    if st.button("开始下载", key="single_video_download"):
        if url:
...
def video_list_tab() -> None:
    ...
    if st.button("开始下载", key="video_list_download"):
        if url:
            with st.spinner("正在下载..."):
...
def favorite_tab() -> None:
    ...
    if st.button("开始下载", key="favorite_download"):
        if url:
            with st.spinner("正在下载..."):
...
def collection_tab() -> None:
    ...
    if st.button("开始下载", key="collection_download"):
        if url:
            with st.spinner("正在下载..."):
...
def bangumi_tab() -> None:
    ...
    if st.button("开始下载", key="bangumi_download"):
        if url:
            with st.spinner("正在下载..."):
